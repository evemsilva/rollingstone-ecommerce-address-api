...
public class RestControllerAspect {
    ...
    private final Counter addressCreatedCounter = Metrics.counter("com.rollingstone.address.created");
	...
	logger.info("This aspect is fired when the createdAddress method of the controller is called");
